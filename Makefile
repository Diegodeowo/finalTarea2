...
all:
	...
	g++ -g -o bin/a bin/employee.o bin/fileReader.o bin/spreadsheet.o bin/main.o
...
test1:
	...
	g++ -g -o bin/tests1 bin/test_Nomina_Horas_Empleados.o  bin/employee.o bin/fileReader.o bin/spreadsheet.o -lgtest -lgtest_main -lpthread
